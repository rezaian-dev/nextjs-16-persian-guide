...
const PREVIEWS = [
  { src: "/preview-toc.webp", full: "/page-toc.png", label: "فهرست مطالب" },
  { src: "/preview-chapter.webp", full: "/page-chapter.png", label: "ساختار فصل" },
  { src: "/preview-code.webp", full: "/page-code.png", label: "نمونهٔ کد" },
  { src: "/preview-workshop.webp", full: "/page-workshop.png", label: "کارگاه پروژه" },
  { src: "/preview-interview.webp", full: "/page-interview.png", label: "پرسش مصاحبه" },
];
