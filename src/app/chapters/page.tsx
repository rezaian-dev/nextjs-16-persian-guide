...
export const metadata: Metadata = {
  title: "فهرست فصل‌ها | مرجع جامع Next.js 16",
      ...
      <main className="container pb-24 pt-36">
        <header className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <p className="mt-3.5 text-base leading-8 text-muted-foreground">
            هر بخش یک مرحله از مسیر است: از App Router تا Production‏. روی هر فصل کلیک کنید تا مستقیم در نسخهٔ آنلاین کتاب باز شود.
          </p>
        ...
        <p className="mt-8 text-center text-[13px] text-muted-foreground">
          مجموع {TOTAL_CHAPTERS} فصل · ۱۷۸ صفحه · رایگان و متن‌باز
        </p>
      </main>
