#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""The online edition — every page of the PDF, readable in a browser at docs/book/.

    python3 src/tools/build_reader.py            # write docs/book/
...
<meta property="og:image" content="https://rezaian-dev.github.io/nextjs-16-persian-guide/social-card.png">
...
def main() -> int:
    ...
    ap.add_argument("--check", action="store_true", help="fail if docs/book is stale")
    args = ap.parse_args()
